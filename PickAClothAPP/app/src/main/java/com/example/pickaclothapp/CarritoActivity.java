...
public class CarritoActivity extends AppCompatActivity {
    ...
    private Button siguiente, borrar;
    private TextView totalPrecio, mensaje1;

    private double precioTotalD = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        borrar = (Button) findViewById(R.id.borrar_carrito);
        totalPrecio = (TextView) findViewById(R.id.precio_total);
        mensaje1 = (TextView) findViewById(R.id.mensaje1);

        auth = FirebaseAuth.getInstance();
        currentUserId = auth.getCurrentUser().getUid();
        carritoRef = FirebaseDatabase.getInstance("https://pickaclothapp-default-rtdb.europe-west1.firebasedatabase.app").getReference().child("Carrito");
        ...
        borrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                carritoRef.child("Usuario compra").child(currentUserId).removeValue();
                Toast.makeText(CarritoActivity.this, "Carrito eliminado con éxito", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        final DatabaseReference CartListRef = FirebaseDatabase.getInstance("https://pickaclothapp-default-rtdb.europe-west1.firebasedatabase.app").getReference().child("Carrito");
        ...
        FirebaseRecyclerAdapter<Carrito, CarritoViewHolder> adapter = new FirebaseRecyclerAdapter<Carrito, CarritoViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CarritoViewHolder holder, int position, @NonNull Carrito model) {
                ...
                double unTipoPrecio =  (Double.valueOf(model.getPrecio())) * Double.valueOf(model.getCantidad());
